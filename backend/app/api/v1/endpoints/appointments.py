...
async def update_appointment_status(
    ...
    return APIResponse(success=True, message=f"Appointment status updated to {data.status.value}", data=updated)
...
async def get_patient_appointments(
    ...
    return APIResponse(success=True, message=f"Retrieved {len(appointments)} patient appointments", data=appointments)
...
async def get_doctor_schedule(
    ...
    return APIResponse(success=True, message=f"Retrieved {len(appointments)} doctor schedule appointments", data=appointments)
